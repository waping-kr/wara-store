                            ...
                            return u((function() {
                                ...
                                return i(this, (function(i) {
                                    switch (i.label) {
                                        ...
                                        case 10:
                                            if (re = i.sent(), a.shallow && re && (X = s.pathname), f && "/_error" !== X && (a._shouldResolveHref = !0, $.pathname = G(X, J), $.pathname !== X && (X = $.pathname, $.pathname = A.addBasePath(X), re || (n = E.formatWithValidation($)))), !U(r)) return te({
                                                url: r,
                                                router: s
                                            }), [2, !1];
                                            if (ne = C.removeLocale(R.removeBasePath(ne), y.locale), ae = d.removeTrailingSlash(X), oe = !1, b.isDynamicRoute(ae))
                                                if (ie = P.parseRelativeUrl(ne), ue = ie.pathname, ce = j.getRouteRegex(ae), oe = O.getRouteMatcher(ce)(ue), se = (le = ae === ue) ? F(ae, ue, Y) : {}, !oe || le && !se.result) {
